...
```
Caracterização das relações (grau, cardinalidade, participação):

1) FORNECEDOR — ENCOMENDA
- Grau: binária
- Cardinalidade: 1:N
- Participação:
	- ENCOMENDA: total (cada encomenda tem exatamente 1 fornecedor)
	- FORNECEDOR: parcial (um fornecedor pode ainda não ter encomendas)

2) ENCOMENDA — PRODUTO
- Grau: binária
- Cardinalidade: M:N
- Participação:
	- ENCOMENDA: total (uma encomenda contém 1 ou mais produtos)
	- PRODUTO: parcial (um produto pode ainda não constar em encomendas)

3) TIPO DE FORNECEDOR — FORNECEDOR
- Grau: binária
- Cardinalidade: 1:N
- Participação:
	- FORNECEDOR: total (cada fornecedor tem 1 tipo)
	- TIPO DE FORNECEDOR: parcial (um tipo pode não ter fornecedores)
```
